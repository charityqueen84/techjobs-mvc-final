...
public class ListController {
    ...
    public String listColumnValues(Model model, @RequestParam String column) {
        ...
        if (column.equals("all")) {
            ArrayList<HashMap<String, String>> results = JobData.findAll(); //changed jobs to results
            model.addAttribute("title", "All Jobs");
            model.addAttribute("results", results); //changed from "jobs", jobs to "results", results
            return "list-jobs";
        } else {
    ...
    public String listJobsByColumnAndValue(Model model, @RequestParam String column, @RequestParam String value) {
        ...
        model.addAttribute("results", results); //changed "jobs", jobs to "results", results
        return "list-jobs";
    }
}
